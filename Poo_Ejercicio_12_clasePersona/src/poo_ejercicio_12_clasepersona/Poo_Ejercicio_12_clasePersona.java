...
anterior.
 */
package poo_ejercicio_12_clasepersona;

import Persona.Persona;
import Servicios.Metodos;
import java.util.Date;

public class Poo_Ejercicio_12_clasePersona {
    ...
    public static void main(String[] args) {
        ...
        P1=S1.crearPersona();
        System.out.println(S1.menorQue(P1, 0)); 
        System.out.println(S1.calcularEdad(P1));
